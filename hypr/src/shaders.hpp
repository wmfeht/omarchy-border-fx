...
inline const std::string SHINY_VERT = R"SHINYVERT(#version 300 es
...
inline const std::string SHINY_FRAG = R"SHINYFRAG(#version 300 es
...
inline const std::string RIPPLE_FRAG = R"RIPPLEFRAG(#version 300 es
precision highp float;
